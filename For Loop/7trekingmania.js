function planinari(input){
    ...
    for (let i = 1; i <= groupCount; i++){ 
        sum += Number(input[i]);
        let peopleCount = Number(input[index]); //input[i]; //Number(input[index]) 
        index++;
   ...
   //console.log(group1Musala);
} 
planinari (["10","10","5","1","100","12","26","17","37","40","78"]); // gj. brao wee, sam 100/100

//planinari (["5","25","41","31","250","6"]);
